...
public interface ExamRecordService {
    ...
    List<ExamAnswer> getRecordAnswers(Long recordId, Long userId, Integer userRole);

    List<ExamQuestionVO> getExamQuestions(Long recordId, Long userId, Integer userRole);
